...
./visualization/visualization.c ./visualization/set_color.c op.c commands/ft_sti.c commands/ft_st.c commands/ft_add_sub.c \
commands/ft_zjump.c commands/ft_fork_lfork.c validate_args.c ft_for_param_valid.c\
visualization/visualization.c visualization/set_color.c visualization/ft_print_info.c visualization/ft_putsrt_vis.c\
visualization/ft_key_plushki.c visualization/ft_panel.c op.c
