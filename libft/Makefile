...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/11/28 12:42:04 by opariy            #+#    #+#              #
#    Updated: 2016/11/28 13:37:11 by opariy           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_bzero.c ft_memccpy.c ft_memcpy.c ft_memchr.c ft_memmove.c ft_memset.c ft_memcmp.c \
		...
		ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_count_words.c \
		ft_foreach.c ft_map.c ft_swap.c ft_is_sort.c ft_lstadd.c ft_lstiter.c ft_lstmap.c 
OBJ = $(SRC:.c=.o)
